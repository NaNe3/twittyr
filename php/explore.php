...
<!--            CONTNET MIDDLE-->
            <div id="content-col">
                <div id="head-cont" style="z-index: 100;">
                    <div class="opt-cont" style="float: right; width: auto; margin: 3px 0px 0px 0px;">
                        <div class="nav-opt">
                            <img src="./res/ast/lever.png" style="height: 24px; width: 24px; margin-right: 0px;" onclick="alert('lever magic')">
                        </div>
                    </div>
                    
                    <div id="search-box" style="width: 90%;">
                        <input id="search-input" type="text" placeholder="Search Twittyr" oninput="search(this.value)" onfocus="document.getElementById('search-drop').style.display = 'block';" onblur="document.getElementById('search-drop').style.display = 'none';" autocomplete="off" style="width: 100%;">
                    ...
                    <div style="width: 100%; display: block; margin: 0; padding: 0;">
                        <div id="trends-select" class="opt-view" style="border-bottom: 2px solid #1DA1F2; color: #1DA1F2;" onclick="switchExplore(this)">
                            Trending
                        </div>
                        <div id="everything-select" class="opt-view" onclick="switchExplore(this)">
...
<!--
                        <div style="max-width: 530px; display: inline-block; margin-top: 12px; padding-left: 16px;">
                            <div class="opt-img" style="float: right; padding: 6px 10px;"><img src="./res/ast/dywn.png" style="width: 10px; height: 10px;"></div>
                            ...
                            <div style="width: 100%; margin-left: -10px;">
                                <div style="width: 25%; overflow: auto; float: left;"><div class="opt-img"><img src="./res/ast/comment.png"></div> <span class="stat">45</span></div>
                                <div style="width: 25%; overflow: auto; float: left;"><div class="opt-img"><img src="./res/ast/retwyyt.png"></div><span class="stat">45</span></div>
                                <div style="width: 25%; overflow: auto; float: left;"><div class="opt-img"><img src="./res/ast/like.png"></div><span class="stat">45</span></div>
                                <div style="width: 25%; overflow: auto; float: left;"><div class="opt-img"><img src="./res/ast/share.png"></div><span class="stat">45</span></div>
                            </div>
