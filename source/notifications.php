...
<!--            LEFT COLUMN-->
            <div id="nav-bar">
                <div id="nav-body" style="position: relative;">
                    ...
                    <div class="opt-cont">
                        <div class="nav-opt">
                            <img src="./res/ast/bell-s.svg">
                            <p class="selected opt-text">Notifications</p>
                        </div>
                    </div>
            ...
            <div id="content-col">
                <div id="head-cont" style="z-index: 100; height: 103px;">
                    ...
                    <div style="width: 100%; display: block; margin: auto -18px; z-index: 100; width: 598px;">
                        <div id="not-select" class="opt-view" style="border-bottom: 2px solid #1DA1F2; color: #1DA1F2;" onclick="switchNotify(this)">
                            All
                        </div>
                        <div id="men-select" class="opt-view" onclick="switchNotify(this)">
                            Mentions
                        </div>
                    </div>
                </div>
